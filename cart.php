                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                         ...
                         <div class="widget widget-cart">
                                ...
                                <div class="order-row bg-white">
                                    ...
                                    $res= mysqli_query($db,"select * from foods where id='$_GET[res_id]'");
                                          while($row=mysqli_fetch_array($res)){
                                     ?>
                                        <div class="title-row">
										<?php echo $row["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["id"]; ?>" >
                                        ...
                                        <div class="form-group row no-gutter">
                                            ...
                                            <div class="col-xs-4">
                                               <input class="form-control" type="text" readonly value='<?php echo $quantity; ?>' id="example-number-input"> </div>
