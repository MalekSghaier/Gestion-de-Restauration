...
<body>
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Food</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from foods where id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/mur.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> <?php echo $rows['price']; ?>DT</a> </li>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["id"]; ?>" >
                                        ...
                                        <div class="form-group row no-gutter">
                                            ...
                                            <div class="col-xs-4">
                                               <input class="form-control" type="text" readonly value='<?php echo $item["quantity"]; ?> DT' id="example-number-input"> </div>
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from foods where id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/'.$product['image'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
										...
										<span class="price pull-left" ><?php echo $product['price']; ?> DT</span>
										  <input class="b-r-0" type="text" name="quantity" value="1" size="2" />
                                            <?php
                                                if(empty($_SESSION["user_id"]))
                                                {
                                                    echo '<a href="login.php"><input type="button" class="btn theme-btn" value="Login To Add to cart" /></a>';
                                                }
                                                else
                                                {
                                                    echo'<input type="submit" class="btn theme-btn" value="Add to cart" />';
                                                }
                                                ?>
