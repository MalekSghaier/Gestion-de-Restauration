...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="admin/images/testt.png">
                    ...
                    <div class="banner-form">
                        <form class="form-inline" method="post" action="search.php">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="search_food" id="exampleInputAmount" placeholder="I would like to eat...." required> </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from res_category"); 
										  ...
										  {
                                                $qres= mysqli_query($db,"SELECT COUNT(ctg_id) as num_food FROM foods where ctg_id='$r[c_id]'"); 
                                                 while($rz=mysqli_fetch_array($qres))
                                                    {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																<h5><a href="products.php?res_id='.$r['c_id'].'">'.$r['c_name'].'</a></h5>
																<div class="product-name">'.$r['descrip'].'</div>
																<div class="price-btn-block"> <span class="price"><a href="products.php?res_id='.$r['c_id'].'">'.$rz['num_food'].' foods</a></span> <a href="products.php?res_id='.$r['c_id'].'" class="btn theme-btn-dash pull-right">Choose Now</a> </div>
															</div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						$ress= mysqli_query($db,"select * from foods");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													// fetch records from res_category table according to catgory ID
													$query= mysqli_query($db,"select * from res_category where c_id='".$rows['ctg_id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['description'].'</span>
