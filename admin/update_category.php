                    ...
                    {        
                                    if($fsize>=1000000)
                                    ...
                                    else
                                        {
                                                ...
                                                $sql = "update res_category set c_name='$_POST[c_name]',descrip='$_POST[c_desc]',img='$fnew' where c_id='$_GET[cat_upd]'";  // update the submited data ino the database :images
                                                mysqli_query($db, $sql); 
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="c_desc" value="<?php echo $row['descrip'];  ?>" class="form-control" placeholder="Description of the category...">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
