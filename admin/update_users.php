...
if(isset($_POST['submit'] ))
{
	...
	elseif(strlen($_POST['phone']) < 8)
	{
        ...
        $mql1 = "SELECT password FROM users WHERE u_id='$_GET[user_upd]'";
        $res = mysqli_query($db, $mql1); 
        $row = mysqli_fetch_array($res);
        $test = $row['password'];

        $mql = "UPDATE users SET username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]', email='$_POST[email]', phone='$_POST[phone]', password='$test' WHERE u_id='$_GET[user_upd]'";
        mysqli_query($db, $mql);
...
<head>
    ...
    <title>D'S-DEV RESTAURANT-MANAGEMENT</title>
    <!-- Bootstrap Core CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-list-alt f-s-20 color-warning"></i><span class="hide-menu">Category</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="add_category.php">All Category</a></li>
