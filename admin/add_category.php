                ...
                $fname = $_FILES['file']['name'];
                    ...
                    {             
                                   if($fsize>=1000000)
                                        ...
                                        {
                                                $sql = "INSERT INTO res_category(c_name,descrip,img) VALUE('".$_POST['c_name']."','".$_POST['c_desc']."','".$fnew."')";
                                                mysqli_query($db, $sql); 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add New Restaurant Category</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="c_desc" class="form-control" placeholder="Description of the category...">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
